...
#Encabezado
encabezado = tkinter.Label(window, text='Buscar información en la Base de Datos', font=('Arial', 12),)
...
def search():
    ...
    busqueda_label = tkinter.Label(window, text= print_info, font=('Arial', 10),)
...
search_btn = tkinter.Button(window, text='Buscar en la Base de Datos', command=search)
